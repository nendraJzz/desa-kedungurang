<x-navbar-layout>
      <div class="relative z-10 flex items-center justify-center min-h-screen">
        <div class="text-center text-white px-4">
          <h1 class="text-4xl md:text-5xl font-bold">Selamat Datang di Desa Kedungurang <br> Kecamatan Gumelar</h1>
    ...
    <div class="relative z-10 bg-white">
      <div class="container mx-auto p-4 md:p-8">
        <h1 class="font-bold text-4xl pb-2 pt-5">Berita Desa</h1>
        <p class="text-lg pb-4">Menyajikan informasi terbaru tentang peristiwa, berita terkini dari Desa Kedungurang</p>
