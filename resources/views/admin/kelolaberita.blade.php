<x-app-layout>
    <div class="pt-24 pb-4 px-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-4xl font-semibold text-black pb-4">Dashboard Berita</h1>
            <div class="bg-white overflow-hidden shadow-lg rounded-md">
                <div class="p-6 font-semibold text-gray-800">
                    {{ __("Hallo,") }} <span class="font-bold text-indigo-700">{{ Auth::user()->name }}!</span> {{ __("Ini adalah halaman untuk mengelola berita.") }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="success-alert" class="fixed inset-0 flex justify-center items-center z-50 opacity-0 scale-90 transition-all duration-500 ease-out">
        <div class="bg-indigo-600 text-white px-6 py-4 rounded-md shadow-lg transform opacity-0 scale-90 w-full sm:max-w-md mx-auto transition-all duration-500 ease-out" role="alert">
    ...
    <div class="flex items-center justify-center p-4 sm:p-8 md:p-12">

        <div class="bg-white p-6 rounded-md shadow-lg w-full max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h1 class="flex justify-center font-bold mb-6 mt-3 text-2xl md:text-4xl">Tambahkan Berita Terkini</h1>
    ...
    <div class="flex items-center justify-center p-4 sm:p-8 md:p-12">
        <div class="bg-white p-6 rounded-md shadow-lg w-full max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h1 class="flex justify-center font-bold mb-6 mt-3 text-2xl md:text-4xl">List Semua Berita</h1>
